...
})({"449tg":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 54539;
...
inputElem.addEventListener("focus", ()=>{
    ...
    if (countryElem.style.display === "block") countriesElem.style.display = "none";
    if (countriesElem.style.display === "flex" && countriesListElem.style.display === "flex") {
        nothingElem.style.display = "none";
        countriesElem.style.display = "flex";
    }
});
inputElem.addEventListener("input", (0, _lodashDefault.default).debounce(()=>{
    makeFetch();
}, 500));
...
const makeFetch = ()=>{
    fetch("https://restcountries.com/v3.1/all").then((response)=>{
        ...
        if (dataFiltered.length > 10) {
            ...
            if (inputElem.value === "") nothingElem.textContent = "Even no results...";
            countryElem.style.display = "none";
...
const makesCountriesDynamicMarkup = (countries)=>{
    ...
    countries.map((country)=>{
        if (i === 0) {
            coutriesList += `<li class="counties-item">
                    <p class="countries-name">${country.name.common}</p>
                </li>`;
            i += 1;
        } else coutriesList += `<li class="counties-item">
...
const makeLanguagesDynamicMarkup = (country)=>{
    ...
    languages.map((language)=>{
        languagesText += `<li class="country-lang">
...
},{}]},["449tg","a0t4e"], "a0t4e", "parcelRequire385e", {})

//# sourceMappingURL=homework-72.31b563d9.js.map
